  ...
  "node_modules/react-tsparticles/cjs/particles.js"(exports) {
    (() => {
      var t = { 757: (t2, e2, r2) => {
        ...
        var e2 = function(t3) {
          ...
          function s(t4, e4, r3, n3) {
            ...
            return i3._invoke = /* @__PURE__ */ function(t5, e5, r4) {
              ...
              return function(o4, i4) {
                if (n4 === p) throw new Error("Generator is already running");
                if (n4 === y) {
          ...
          function P(t4, r3) {
            ...
            if (n3 === e3) {
              if (r3.delegate = null, "throw" === r3.method) {
                if (t4.iterator.return && (r3.method = "return", r3.arg = e3, P(t4, r3), "throw" === r3.method)) return d;
                r3.method = "throw", r3.arg = new TypeError("The iterator does not provide a 'throw' method");
              }
              return d;
            }
            var o3 = f(n3, t4.iterator, r3.arg);
            if ("throw" === o3.type) return r3.method = "throw", r3.arg = o3.arg, r3.delegate = null, d;
            var i3 = o3.arg;
            ...
            if (t4) {
              ...
              if (!isNaN(t4.length)) {
                var o3 = -1, a2 = function r4() {
                  for (; ++o3 < t4.length; ) if (n2.call(t4, o3)) return r4.value = t4[o3], r4.done = false, r4;
          ...
          return m.prototype = O.constructor = g, g.constructor = m, m.displayName = u(g, c, "GeneratorFunction"), t3.isGeneratorFunction = function(t4) {
            ...
            var e4 = [];
            for (var r3 in t4) e4.push(r3);
            return e4.reverse(), function r4() {
              for (; e4.length; ) {
                var n3 = e4.pop();
                if (n3 in t4) return r4.value = n3, r4.done = false, r4;
              }
              return r4.done = true, r4;
            };
          }, t3.values = S, k.prototype = { constructor: k, reset: function(t4) {
            if (this.prev = 0, this.next = 0, this.sent = this._sent = e3, this.done = false, this.delegate = null, this.method = "next", this.arg = e3, this.tryEntries.forEach(L), !t4) for (var r3 in this) "t" === r3.charAt(0) && n2.call(this, r3) && !isNaN(+r3.slice(1)) && (this[r3] = e3);
          }, stop: function() {
            this.done = true;
            ...
            for (var e4 = this.tryEntries.length - 1; e4 >= 0; --e4) {
              ...
              if (r3.finallyLoc === t4) return this.complete(r3.completion, r3.afterLoc), L(r3), d;
            }
          }, catch: function(t4) {
            for (var e4 = this.tryEntries.length - 1; e4 >= 0; --e4) {
              var r3 = this.tryEntries[e4];
      ...
      (() => {
        ...
        function u(t3, e3) {
          if (e3 && ("object" === c(e3) || "function" == typeof e3)) return e3;
        ...
        var v = function(t3, e3, r2, n2) {
          ...
          var n2, o3, c2, s2, l2 = (c2 = y2, s2 = function() {
            ...
            } else t3 = r3.apply(this, arguments);
            return u(this, t3);
          });
          function y2(t3) {
            var e3;
