...
function b(e, t = {}) {
  ...
  return async function(p) {
    ...
    let E = o?.getElement(CardElement), V = m && E ? () => m.createPaymentMethod({ type: "card", card: E, billing_details: J(u) }) : void 0, y = await s.submitForm(e, u, { endpoint: l, clientName: L, createPaymentMethod: V });
    (0, import_core2.isSubmissionError)(y) ? a?.(y) : i?.(y);
  };
}
function Y(e) {
